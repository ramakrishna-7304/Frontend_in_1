			...
			<motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
				<header className="relative overflow-hidden">
					...
					<div className="max-w-5xl mx-auto px-6 py-20">
						<h1 className="text-4xl md:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">{service.title}</h1>
						<p className="mt-4 text-white/80 max-w-3xl">{service.detail}</p>
						<div className="mt-8 flex gap-3">
							<a href="#contact" className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-primary to-secondary font-semibold shadow-lg">Start a project</a>
